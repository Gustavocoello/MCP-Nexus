...
DB_HOST = os.getenv("POSTGRES_WIN_HOST")
DB_USER = os.getenv("POSTGRES_WIN_USER")
DB_PASS = os.getenv("POSTGRES_WIN_PASS")
DB_NAME = os.getenv("POSTGRES_WIN_NAME")
DB_PORT = "5432"
...
def get_pg_engine():
    ...
    try:
        ...
        print(f"🛠 Conexión a Postgres con windows ({DB_NAME}) validada")
