...
metadata:
  ...
  version: "1.0"
  scope: [koda, jarvis, ragel, lamar]
  auto_invoke:
    - "cómo escribir workflows en GitHub Actions"
    - "explicar sintaxis de GitHub Actions"
    - "documentación oficial de GitHub Actions"
    - "migrar de Jenkins/CircleCI a GitHub Actions"
    - "configurar runners en GitHub Actions"
    - "usar secrets/OIDC en GitHub Actions"
    - "crear acciones reutilizables en GitHub"
    - "solucionar problemas en GitHub Actions"
    - "ejemplos de YAML para GitHub Actions"
allowed-tools: []
---
